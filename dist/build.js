...
/***/ function(module, exports, __webpack_require__) {
	...
	var VueResource = __webpack_require__(35);
	...
	Vue.directive('mdl', function () {
	  ...
	  if ((typeof componentHandler === 'undefined' ? 'undefined' : (0, _typeof3.default)(componentHandler)) == 'object') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _NewsFeed = __webpack_require__(54);

	var _NewsFeed2 = _interopRequireDefault(_NewsFeed);

	var _GlobaloriaMap = __webpack_require__(59);

	var _GlobaloriaMap2 = _interopRequireDefault(_GlobaloriaMap);
	...
	exports.default = {
	    ...
	    components: {
	        Grid: _Grid2.default,
	        NewsFeed: _NewsFeed2.default,
	        GlobaloriaMap: _GlobaloriaMap2.default
	    }
	};
	// </script>
	// <style scoped>
...
/***/ function(module, exports) {
	...
	exports.default = {
	    ...
	    computed: {
	        schoolFilterFullname: function schoolFilterFullname() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	$export($export.P, 'Set', {toJSON: __webpack_require__(93)('Set')});
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.initMap = function (defaultColoring, bubblesData, states) {
	  ...
	  var map = new Datamap({
	    ...
	    setProjection: function setProjection(element, options) {
	      var projection, path;
	      projection = d3.geo.albersUsa().translate([width / 2, height / 2]);
